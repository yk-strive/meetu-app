...
/***/ 15:
/*!********************************************************!*\
  !*** H:/Github/meetu-app/project-meetu/store/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    changeVal: function changeVal(state) {var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { stateKey: stateKey, newValue: newValue }; // 更新仓库中的某变量的值
      state[options.stateKey] = options.newValue;
      console.log('m-' + options.stateKey, options.newValue);
    } },

  actions: {
    changeVal: function changeVal(_ref) {var commit = _ref.commit;var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : { stateKey: stateKey, newValue: newValue };
...
http_v1.interceptor.request(function (config, cancel) {/*请求之前拦截器*/
...
/**
     ...
     * */
http_v1.validateStatus = function (statusCode) {
  return statusCode === 200;
};

http_v1.interceptor.response(function (response) {/* 请求之后拦截器 */
  if (response.data.code !== 0) {
    return Promise.reject(response);
  }
  return response.data;
}, function (response) {// 请求错误的处理
  return response;
});
...
/***/ 18:
/*!************************************************************************!*\
  !*** H:/Github/meetu-app/project-meetu/common/luch-request/request.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/initial/wxoauth": { "usingComponents": {} }, "pages/initial/personaldata": { "usingComponents": { "w-picker": "/components/w-picker/w-picker", "picture-tailor": "/components/picture-tailor/pictureTailor" } }, "pages/home/index": { "usingComponents": { "cu-modal": "/meetu-ui/components/cu-modal" } }, "pages/send/text": { "usingComponents": {} }, "pages/send/voice": { "usingComponents": {} }, "pages/search/search": { "usingComponents": { "cu-modal": "/meetu-ui/components/cu-modal" } }, "pages/chat/list": { "usingComponents": { "mix-pulldown-refresh": "/components/mix-pulldown-refresh/mix-pulldown-refresh", "mix-load-more": "/components/mix-load-more/mix-load-more" } }, "pages/chat/chat": { "usingComponents": {} }, "pages/user/index": { "usingComponents": {} }, "pages/user/signal": { "usingComponents": { "mix-pulldown-refresh": "/components/mix-pulldown-refresh/mix-pulldown-refresh", "mix-load-more": "/components/mix-load-more/mix-load-more" } }, "pages/user/coin": { "usingComponents": { "cu-modal": "/meetu-ui/components/cu-modal" } }, "pages/user/coinrecord": { "usingComponents": {} }, "pages/user/settings": { "usingComponents": {} } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "Meet U", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#DADADA", "navigationStyle": "custom" } };exports.default = _default;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "appid": "__UNI__2A25171" };exports.default = _default;
