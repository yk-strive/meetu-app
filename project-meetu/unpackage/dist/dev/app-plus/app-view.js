...
Z([[4],[[5],[[5],[1,'content shadow']],[[2,'?:'],[[2,'=='],[[6],[[7],[3,'item']],[3,'user_id']],[[6],[[7],[3,'userInfo']],[3,'id']]],[1,'bg-color-main'],[1,'']]]])
...
Z([3,'text-cut'])
Z([a,[[2,'+'],[[2,'+'],[1,''],[[2,'?:'],[[2,'=='],[[6],[[7],[3,'item']],[3,'type']],[1,1]],[[6],[[7],[3,'item']],[3,'content']],[[2,'?:'],[[2,'=='],[[6],[[7],[3,'item']],[3,'contenttype']],[1,3]],[1,'[图片]'],[1,'']]]],[1,'']]])
Z([3,'action'])
...
var a0E=_n('view')
var tAF=_mz(z,'view',['class',27,'id',1],[],c7E,o6E,gg)
var oDF=_n('view')
_rz(z,oDF,'class',29,c7E,o6E,gg)
var xEF=_n('text')
_rz(z,xEF,'class',30,c7E,o6E,gg)
var oFF=_oz(z,31,c7E,o6E,gg)
_(xEF,oFF)
_(oDF,xEF)
_(tAF,oDF)
var eBF=_v()
_(tAF,eBF)
if(_oz(z,32,c7E,o6E,gg)){eBF.wxVkey=1
var fGF=_n('view')
_rz(z,fGF,'class',33,c7E,o6E,gg)
var cHF=_mz(z,'image',['class',34,'mode',1,'src',2],[],c7E,o6E,gg)
_(fGF,cHF)
_(eBF,fGF)
}
var hIF=_n('view')
_rz(z,hIF,'class',37,c7E,o6E,gg)
var oJF=_v()
_(hIF,oJF)
if(_oz(z,38,c7E,o6E,gg)){oJF.wxVkey=1
var lMF=_n('view')
_rz(z,lMF,'class',39,c7E,o6E,gg)
var aNF=_n('text')
var tOF=_oz(z,40,c7E,o6E,gg)
_(aNF,tOF)
_(lMF,aNF)
_(oJF,lMF)
}
var cKF=_v()
_(hIF,cKF)
if(_oz(z,41,c7E,o6E,gg)){cKF.wxVkey=1
var ePF=_mz(z,'view',['catchtap',42,'class',1,'data-event-opts',2],[],c7E,o6E,gg)
var bQF=_mz(z,'image',['class',45,'mode',1,'src',2],[],c7E,o6E,gg)
_(ePF,bQF)
_(cKF,ePF)
}
var oLF=_v()
_(hIF,oLF)
if(_oz(z,48,c7E,o6E,gg)){oLF.wxVkey=1
var oRF=_n('view')
var xSF=_n('view')
_rz(z,xSF,'class',49,c7E,o6E,gg)
var oTF=_n('text')
_rz(z,oTF,'class',50,c7E,o6E,gg)
_(xSF,oTF)
var fUF=_n('text')
_rz(z,fUF,'class',51,c7E,o6E,gg)
var cVF=_oz(z,52,c7E,o6E,gg)
_(fUF,cVF)
_(xSF,fUF)
_(oRF,xSF)
_(oLF,oRF)
...
var bCF=_v()
_(tAF,bCF)
if(_oz(z,53,c7E,o6E,gg)){bCF.wxVkey=1
var hWF=_n('view')
_rz(z,hWF,'class',54,c7E,o6E,gg)
var oXF=_mz(z,'image',['class',55,'mode',1,'src',2],[],c7E,o6E,gg)
_(hWF,oXF)
_(bCF,hWF)
}
eBF.wxXCkey=1
...
var oZF=_mz(z,'view',['bindtap',60,'class',1,'data-event-opts',2],[],e,s,gg)
var l1F=_n('text')
_rz(z,l1F,'class',63,e,s,gg)
_(oZF,l1F)
_(cYF,oZF)
var a2F=_mz(z,'textarea',['adjustPosition',64,'autoHeight',1,'bindblur',2,'bindfocus',3,'bindinput',4,'class',5,'cursorSpacing',6,'data-event-opts',7,'fixed',8,'placeholder',9,'showConfirmBar',10,'value',11],[],e,s,gg)
_(cYF,a2F)
var t3F=_n('view')
_rz(z,t3F,'class',76,e,s,gg)
var e4F=_n('text')
_rz(z,e4F,'class',77,e,s,gg)
_(t3F,e4F)
var b5F=_mz(z,'input',['bindblur',78,'bindtap',1,'data-event-opts',2,'type',3],[],e,s,gg)
_(t3F,b5F)
_(cYF,t3F)
_(oRE,cYF)
_(r,oRE)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:1496:6)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:1496:6)",{path:"./app.wxss"});    
