...
var oRM=_mz(z,'view',['catchtap',30,'class',1,'data-event-opts',2],[],tOM,aNM,gg)
var xSM=_n('view')
_rz(z,xSM,'class',33,tOM,aNM,gg)
var oTM=_n('image')
_rz(z,oTM,'src',34,tOM,aNM,gg)
_(xSM,oTM)
_(oRM,xSM)
var fUM=_n('view')
_rz(z,fUM,'class',35,tOM,aNM,gg)
var cVM=_n('view')
_rz(z,cVM,'class',36,tOM,aNM,gg)
var hWM=_oz(z,37,tOM,aNM,gg)
_(cVM,hWM)
_(fUM,cVM)
var oXM=_n('view')
_rz(z,oXM,'class',38,tOM,aNM,gg)
var cYM=_oz(z,39,tOM,aNM,gg)
_(oXM,cYM)
_(fUM,oXM)
_(oRM,fUM)
var oZM=_n('view')
_rz(z,oZM,'class',40,tOM,aNM,gg)
var l1M=_n('text')
var a2M=_oz(z,41,tOM,aNM,gg)
_(l1M,a2M)
var t3M=_n('text')
_rz(z,t3M,'class',42,tOM,aNM,gg)
var e4M=_oz(z,43,tOM,aNM,gg)
_(t3M,e4M)
_(l1M,t3M)
_(oZM,l1M)
_(oRM,oZM)
...
_(o8L,hIM)
_(o6L,o8L)
var b5M=_mz(z,'cu-modal',['bind:__l',44,'bind:hideModal',1,'data-event-opts',2,'modalName',3,'vueId',4,'vueSlots',5],[],e,s,gg)
var o6M=_n('view')
_rz(z,o6M,'slot',50,e,s,gg)
var x7M=_n('view')
_rz(z,x7M,'class',51,e,s,gg)
var o8M=_n('view')
...
var tGN=_mz(z,'view',['catchtap',58,'class',1,'data-event-opts',2],[],oDN,cCN,gg)
var oJN=_n('view')
_rz(z,oJN,'class',61,oDN,cCN,gg)
var xKN=_mz(z,'image',['class',62,'src',1],[],oDN,cCN,gg)
_(oJN,xKN)
var oLN=_n('text')
_rz(z,oLN,'class',64,oDN,cCN,gg)
var fMN=_oz(z,65,oDN,cCN,gg)
_(oLN,fMN)
_(oJN,oLN)
_(tGN,oJN)
var eHN=_v()
_(tGN,eHN)
if(_oz(z,66,oDN,cCN,gg)){eHN.wxVkey=1
var cNN=_n('view')
_rz(z,cNN,'class',67,oDN,cCN,gg)
var hON=_n('text')
_rz(z,hON,'class',68,oDN,cCN,gg)
var oPN=_oz(z,69,oDN,cCN,gg)
_(hON,oPN)
_(cNN,hON)
var cQN=_n('text')
_rz(z,cQN,'class',70,oDN,cCN,gg)
var oRN=_oz(z,71,oDN,cCN,gg)
_(cQN,oRN)
var lSN=_n('text')
_rz(z,lSN,'class',72,oDN,cCN,gg)
var aTN=_oz(z,73,oDN,cCN,gg)
_(lSN,aTN)
_(cQN,lSN)
_(cNN,cQN)
_(eHN,cNN)
...
var tUN=_n('view')
_rz(z,tUN,'class',74,oDN,cCN,gg)
var eVN=_n('text')
_rz(z,eVN,'class',75,oDN,cCN,gg)
var bWN=_oz(z,76,oDN,cCN,gg)
_(eVN,bWN)
_(tUN,eVN)
_(tGN,tUN)
var bIN=_v()
_(tGN,bIN)
if(_oz(z,77,oDN,cCN,gg)){bIN.wxVkey=1
var oXN=_n('view')
_rz(z,oXN,'class',78,oDN,cCN,gg)
var xYN=_n('text')
var oZN=_oz(z,79,oDN,cCN,gg)
_(xYN,oZN)
_(oXN,xYN)
_(bIN,oXN)
}
...
var h3N=_mz(z,'custom-nav',['bind:__l',2,'bind:tabChange',1,'data-event-opts',2,'isBack',3,'tabsInfo',4,'vueId',5],[],e,s,gg)
_(c2N,h3N)
var o4N=_n('view')
...
var bAO=_n('view')
_rz(z,bAO,'class',13,a8N,l7N,gg)
var oBO=_n('view')
_rz(z,oBO,'class',14,a8N,l7N,gg)
var xCO=_n('view')
_rz(z,xCO,'class',15,a8N,l7N,gg)
var oDO=_oz(z,16,a8N,l7N,gg)
_(xCO,oDO)
_(oBO,xCO)
var fEO=_n('view')
_rz(z,fEO,'class',17,a8N,l7N,gg)
var cFO=_oz(z,18,a8N,l7N,gg)
_(fEO,cFO)
_(oBO,fEO)
_(bAO,oBO)
var hGO=_n('view')
_rz(z,hGO,'class',19,a8N,l7N,gg)
var oHO=_n('text')
var cIO=_oz(z,20,a8N,l7N,gg)
_(oHO,cIO)
var oJO=_n('text')
_rz(z,oJO,'class',21,a8N,l7N,gg)
var lKO=_oz(z,22,a8N,l7N,gg)
_(oJO,lKO)
_(oHO,oJO)
_(hGO,oHO)
_(bAO,hGO)
...
c5N.wxXCkey=2
_2z(z,11,o6N,e,s,gg,c5N,'item','index','id')
_(c2N,o4N)
_(r,c2N)
return r
}
...
var eNO=_mz(z,'custom-nav',['bind:__l',2,'bind:right',1,'data-event-opts',2,'isBack',3,'textRight',4,'vueId',5],[],e,s,gg)
_(tMO,eNO)
var bOO=_n('view')
...
var fSO=_mz(z,'image',['class',12,'mode',1,'src',2],[],e,s,gg)
_(oRO,fSO)
_(xQO,oRO)
var cTO=_n('view')
_rz(z,cTO,'class',15,e,s,gg)
var hUO=_mz(z,'image',['class',16,'mode',1,'src',2],[],e,s,gg)
_(cTO,hUO)
_(xQO,cTO)
_(oPO,xQO)
var oVO=_n('view')
...
_(cWO,oXO)
_(oVO,cWO)
var lYO=_mz(z,'image',['mode',21,'src',1],[],e,s,gg)
_(oVO,lYO)
_(oPO,oVO)
var aZO=_n('view')
...
_(b3O,o4O)
_(aZO,b3O)
var x5O=_mz(z,'text',['bindtap',26,'class',1,'data-event-opts',2],[],e,s,gg)
...
var tEP=_mz(z,'view',['bindtap',36,'class',1,'data-event-opts',2],[],oBP,cAP,gg)
var eFP=_n('view')
_rz(z,eFP,'class',39,oBP,cAP,gg)
var bGP=_mz(z,'image',['mode',40,'src',1],[],oBP,cAP,gg)
_(eFP,bGP)
var oHP=_n('text')
_rz(z,oHP,'class',42,oBP,cAP,gg)
var xIP=_oz(z,43,oBP,cAP,gg)
_(oHP,xIP)
_(eFP,oHP)
_(tEP,eFP)
_(lCP,tEP)
...
h9O.wxXCkey=2
_2z(z,34,o0O,e,s,gg,h9O,'item','index','index')
_(f7O,c8O)
_(bOO,f7O)
_(tMO,bOO)
_(r,tMO)
...
var cLP=_mz(z,'custom-nav',['bind:__l',2,'isBack',1,'textTitle',2,'vueId',3],[],e,s,gg)
_(fKP,cLP)
var hMP=_n('view')
...
var oVP=_mz(z,'view',['bindtap',13,'class',1,'data-event-opts',2],[],tSP,aRP,gg)
var xWP=_n('view')
_rz(z,xWP,'class',16,tSP,aRP,gg)
var oXP=_n('text')
_rz(z,oXP,'class',17,tSP,aRP,gg)
var fYP=_oz(z,18,tSP,aRP,gg)
_(oXP,fYP)
_(xWP,oXP)
_(oVP,xWP)
_(eTP,oVP)
...
oPP.wxXCkey=2
_2z(z,11,lQP,e,s,gg,oPP,'item','index','index')
_(oNP,cOP)
_(hMP,oNP)
var cZP=_n('view')
_rz(z,cZP,'class',19,e,s,gg)
var h1P=_mz(z,'button',['bindtap',20,'class',1,'data-event-opts',2],[],e,s,gg)
...
var l5P=_mz(z,'custom-nav',['bind:__l',2,'bind:tabChange',1,'data-event-opts',2,'isBack',3,'tabsInfo',4,'vueId',5],[],e,s,gg)
_(o4P,l5P)
var a6P=_n('view')
_rz(z,a6P,'class',8,e,s,gg)
var t7P=_mz(z,'scroll-view',['class',9,'scrollY',1],[],e,s,gg)
var e8P=_n('view')
...
var hEQ=_n('view')
_rz(z,hEQ,'class',16,oBQ,xAQ,gg)
var oFQ=_n('view')
_rz(z,oFQ,'class',17,oBQ,xAQ,gg)
var cGQ=_n('text')
_rz(z,cGQ,'class',18,oBQ,xAQ,gg)
var oHQ=_oz(z,19,oBQ,xAQ,gg)
_(cGQ,oHQ)
_(oFQ,cGQ)
var lIQ=_n('text')
var aJQ=_oz(z,20,oBQ,xAQ,gg)
_(lIQ,aJQ)
_(oFQ,lIQ)
var tKQ=_n('text')
var eLQ=_oz(z,21,oBQ,xAQ,gg)
_(tKQ,eLQ)
_(oFQ,tKQ)
_(hEQ,oFQ)
var bMQ=_v()
...
var hSQ=_n('view')
_rz(z,hSQ,'class',26,oPQ,xOQ,gg)
var oTQ=_v()
_(hSQ,oTQ)
if(_oz(z,27,oPQ,xOQ,gg)){oTQ.wxVkey=1
var oVQ=_n('view')
_rz(z,oVQ,'class',28,oPQ,xOQ,gg)
var lWQ=_n('text')
var aXQ=_oz(z,29,oPQ,xOQ,gg)
_(lWQ,aXQ)
_(oVQ,lWQ)
_(oTQ,oVQ)
}
var cUQ=_v()
_(hSQ,cUQ)
if(_oz(z,30,oPQ,xOQ,gg)){cUQ.wxVkey=1
var tYQ=_mz(z,'view',['catchtap',31,'class',1,'data-event-opts',2],[],oPQ,xOQ,gg)
var eZQ=_n('view')
_rz(z,eZQ,'class',34,oPQ,xOQ,gg)
var b1Q=_mz(z,'image',['mode',35,'src',1],[],oPQ,xOQ,gg)
_(eZQ,b1Q)
_(tYQ,eZQ)
var o2Q=_n('text')
var x3Q=_oz(z,37,oPQ,xOQ,gg)
_(o2Q,x3Q)
_(tYQ,o2Q)
_(cUQ,tYQ)
}
var o4Q=_n('view')
_rz(z,o4Q,'class',38,oPQ,xOQ,gg)
var f5Q=_n('view')
_rz(z,f5Q,'class',39,oPQ,xOQ,gg)
var c6Q=_n('text')
var h7Q=_oz(z,40,oPQ,xOQ,gg)
_(c6Q,h7Q)
_(f5Q,c6Q)
_(o4Q,f5Q)
var o8Q=_n('view')
_rz(z,o8Q,'class',41,oPQ,xOQ,gg)
var c9Q=_n('text')
_rz(z,c9Q,'class',42,oPQ,xOQ,gg)
_(o8Q,c9Q)
var o0Q=_oz(z,43,oPQ,xOQ,gg)
_(o8Q,o0Q)
_(o4Q,o8Q)
var lAR=_n('view')
_rz(z,lAR,'class',44,oPQ,xOQ,gg)
var aBR=_n('text')
_rz(z,aBR,'class',45,oPQ,xOQ,gg)
_(lAR,aBR)
var tCR=_oz(z,46,oPQ,xOQ,gg)
_(lAR,tCR)
_(o4Q,lAR)
_(hSQ,o4Q)
oTQ.wxXCkey=1
...
bMQ.wxXCkey=2
_2z(z,24,oNQ,oBQ,xAQ,gg,bMQ,'citem','cindex','id')
_(fCQ,hEQ)
return fCQ
}
b9P.wxXCkey=2
_2z(z,14,o0P,e,s,gg,b9P,'item','key','key')
_(t7P,e8P)
_(a6P,t7P)
_(o4P,a6P)
_(r,o4P)
