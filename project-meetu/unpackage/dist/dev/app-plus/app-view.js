...
var tAF=_v()
_(a0E,tAF)
if(_oz(z,28,c7E,o6E,gg)){tAF.wxVkey=1
var eBF=_mz(z,'view',['class',29,'id',1],[],c7E,o6E,gg)
var xEF=_n('view')
_rz(z,xEF,'class',31,c7E,o6E,gg)
var oFF=_n('text')
_rz(z,oFF,'class',32,c7E,o6E,gg)
var fGF=_oz(z,33,c7E,o6E,gg)
_(oFF,fGF)
_(xEF,oFF)
_(eBF,xEF)
var bCF=_v()
_(eBF,bCF)
if(_oz(z,34,c7E,o6E,gg)){bCF.wxVkey=1
var cHF=_n('view')
_rz(z,cHF,'class',35,c7E,o6E,gg)
var hIF=_mz(z,'image',['class',36,'src',1],[],c7E,o6E,gg)
_(cHF,hIF)
_(bCF,cHF)
}
var oJF=_n('view')
_rz(z,oJF,'class',38,c7E,o6E,gg)
var cKF=_v()
_(oJF,cKF)
if(_oz(z,39,c7E,o6E,gg)){cKF.wxVkey=1
var aNF=_n('view')
_rz(z,aNF,'class',40,c7E,o6E,gg)
var tOF=_n('text')
var ePF=_oz(z,41,c7E,o6E,gg)
_(tOF,ePF)
_(aNF,tOF)
_(cKF,aNF)
}
var oLF=_v()
_(oJF,oLF)
if(_oz(z,42,c7E,o6E,gg)){oLF.wxVkey=1
var bQF=_mz(z,'view',['catchtap',43,'class',1,'data-event-opts',2],[],c7E,o6E,gg)
var oRF=_mz(z,'image',['class',46,'mode',1,'src',2],[],c7E,o6E,gg)
_(bQF,oRF)
_(oLF,bQF)
}
var lMF=_v()
_(oJF,lMF)
if(_oz(z,49,c7E,o6E,gg)){lMF.wxVkey=1
var xSF=_n('view')
var oTF=_n('view')
_rz(z,oTF,'class',50,c7E,o6E,gg)
var fUF=_n('text')
_rz(z,fUF,'class',51,c7E,o6E,gg)
_(oTF,fUF)
var cVF=_n('text')
_rz(z,cVF,'class',52,c7E,o6E,gg)
var hWF=_oz(z,53,c7E,o6E,gg)
_(cVF,hWF)
_(oTF,cVF)
_(xSF,oTF)
_(lMF,xSF)
...
var oDF=_v()
_(eBF,oDF)
if(_oz(z,54,c7E,o6E,gg)){oDF.wxVkey=1
var oXF=_n('view')
_rz(z,oXF,'class',55,c7E,o6E,gg)
var cYF=_mz(z,'image',['class',56,'src',1],[],c7E,o6E,gg)
_(oXF,cYF)
_(oDF,oXF)
}
bCF.wxXCkey=1
...
lUE.wxXCkey=1
_(oRE,oTE)
var oZF=_mz(z,'view',['class',58,'style',1],[],e,s,gg)
var l1F=_mz(z,'view',['bindtap',60,'class',1,'data-event-opts',2],[],e,s,gg)
var a2F=_n('text')
_rz(z,a2F,'class',63,e,s,gg)
_(l1F,a2F)
_(oZF,l1F)
var t3F=_mz(z,'textarea',['adjustPosition',64,'autoHeight',1,'bindblur',2,'bindfocus',3,'bindinput',4,'class',5,'cursorSpacing',6,'data-event-opts',7,'fixed',8,'placeholder',9,'showConfirmBar',10,'value',11],[],e,s,gg)
_(oZF,t3F)
var e4F=_n('view')
_rz(z,e4F,'class',76,e,s,gg)
var b5F=_n('text')
_rz(z,b5F,'class',77,e,s,gg)
_(e4F,b5F)
var o6F=_mz(z,'input',['bindblur',78,'bindtap',1,'data-event-opts',2,'type',3],[],e,s,gg)
_(e4F,o6F)
_(oZF,e4F)
_(oRE,oZF)
_(r,oRE)
...
var f9F=_mz(z,'custom-nav',['bind:__l',2,'isBack',1,'textTitle',2,'vueId',3],[],e,s,gg)
_(o8F,f9F)
var c0F=_n('view')
_rz(z,c0F,'class',6,e,s,gg)
var hAG=_mz(z,'mix-pulldown-refresh',['bind:__l',7,'bind:refresh',1,'bind:setEnableScroll',2,'class',3,'data-event-opts',4,'data-ref',5,'top',6,'vueId',7,'vueSlots',8],[],e,s,gg)
var oBG=_mz(z,'scroll-view',['bindscrolltolower',16,'class',1,'data-event-opts',2,'scrollY',3],[],e,s,gg)
var cCG=_n('view')
_rz(z,cCG,'class',20,e,s,gg)
var oDG=_v()
_(cCG,oDG)
var lEG=function(tGG,aFG,eHG,gg){
var oJG=_mz(z,'view',['catchtap',25,'class',1,'data-event-opts',2],[],tGG,aFG,gg)
var xKG=_n('view')
_rz(z,xKG,'class',28,tGG,aFG,gg)
var oLG=_mz(z,'image',['class',29,'mode',1,'src',2],[],tGG,aFG,gg)
_(xKG,oLG)
_(oJG,xKG)
var fMG=_n('view')
_rz(z,fMG,'class',32,tGG,aFG,gg)
var cNG=_n('view')
_rz(z,cNG,'class',33,tGG,aFG,gg)
var hOG=_oz(z,34,tGG,aFG,gg)
_(cNG,hOG)
_(fMG,cNG)
var oPG=_n('view')
_rz(z,oPG,'class',35,tGG,aFG,gg)
var cQG=_n('view')
_rz(z,cQG,'class',36,tGG,aFG,gg)
var oRG=_oz(z,37,tGG,aFG,gg)
_(cQG,oRG)
_(oPG,cQG)
_(fMG,oPG)
_(oJG,fMG)
var lSG=_n('view')
_rz(z,lSG,'class',38,tGG,aFG,gg)
var aTG=_n('view')
_rz(z,aTG,'class',39,tGG,aFG,gg)
var tUG=_oz(z,40,tGG,aFG,gg)
_(aTG,tUG)
_(lSG,aTG)
var eVG=_mz(z,'view',['class',41,'hidden',1],[],tGG,aFG,gg)
var bWG=_oz(z,43,tGG,aFG,gg)
_(eVG,bWG)
_(lSG,eVG)
_(oJG,lSG)
_(eHG,oJG)
...
oDG.wxXCkey=2
_2z(z,23,lEG,e,s,gg,oDG,'item','index','index')
_(oBG,cCG)
var oXG=_mz(z,'mix-load-more',['bind:__l',44,'show',1,'status',2,'vueId',3],[],e,s,gg)
_(oBG,oXG)
_(hAG,oBG)
_(c0F,hAG)
_(o8F,c0F)
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:1490:6)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:1490:6)",{path:"./app.wxss"});    
