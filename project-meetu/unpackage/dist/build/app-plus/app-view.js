...
var aBD=_mz(z,'custom-nav',['bind:__l',2,'isBack',1,'vueId',2],[],e,s,gg)
_(lAD,aBD)
var tCD=_n('view')
...
var oFD=_mz(z,'image',['class',8,'src',1],[],e,s,gg)
_(bED,oFD)
_(lAD,bED)
_(r,lAD)
return r
...
var fID=_mz(z,'custom-nav',['bind:__l',2,'isBack',1,'vueId',2],[],e,s,gg)
_(oHD,fID)
var cJD=_n('scroll-view')
_rz(z,cJD,'scrollY',5,e,s,gg)
var hKD=_n('view')
_rz(z,hKD,'class',6,e,s,gg)
var oLD=_mz(z,'image',['class',7,'mode',1,'src',2],[],e,s,gg)
_(hKD,oLD)
var cMD=_n('view')
_rz(z,cMD,'class',10,e,s,gg)
var oND=_mz(z,'image',['bindtap',11,'class',1,'data-event-opts',2,'src',3],[],e,s,gg)
_(cMD,oND)
_(hKD,cMD)
_(cJD,hKD)
var lOD=_mz(z,'form',['action',-1,'bindsubmit',15,'data-event-opts',1],[],e,s,gg)
var aPD=_n('view')
...
_(eRD,bSD)
_(tQD,eRD)
var oTD=_mz(z,'input',['class',21,'name',1,'value',2],[],e,s,gg)
_(tQD,oTD)
_(aPD,tQD)
var xUD=_n('view')
...
_(fWD,hYD)
_(xUD,fWD)
var c1D=_mz(z,'view',['bindtap',29,'class',1,'data-event-opts',2],[],e,s,gg)
var o2D=_oz(z,32,e,s,gg)
_(c1D,o2D)
_(xUD,c1D)
var oVD=_v()
_(xUD,oVD)
if(_oz(z,33,e,s,gg)){oVD.wxVkey=1
var l3D=_mz(z,'w-picker',['bind:__l',34,'bind:confirm',1,'class',2,'data-event-opts',3,'data-ref',4,'defaultVal',5,'mode',6,'selectList',7,'themeColor',8,'vueId',9],[],e,s,gg)
_(oVD,l3D)
}
oVD.wxXCkey=1
oVD.wxXCkey=3
...
_(t5D,e6D)
_(a4D,t5D)
var b7D=_mz(z,'view',['bindtap',47,'class',1,'data-event-opts',2],[],e,s,gg)
var o8D=_oz(z,50,e,s,gg)
_(b7D,o8D)
_(a4D,b7D)
var x9D=_mz(z,'w-picker',['bind:__l',51,'bind:confirm',1,'class',2,'current',3,'data-event-opts',4,'data-ref',5,'defaultVal',6,'disabledAfter',7,'endYear',8,'mode',9,'startYear',10,'themeColor',11,'vueId',12],[],e,s,gg)
_(a4D,x9D)
_(aPD,a4D)
var o0D=_n('view')
_rz(z,o0D,'class',64,e,s,gg)
var fAE=_n('view')
_rz(z,fAE,'class',65,e,s,gg)
var cBE=_oz(z,66,e,s,gg)
_(fAE,cBE)
_(o0D,fAE)
var hCE=_mz(z,'view',['bindtap',67,'class',1,'data-event-opts',2],[],e,s,gg)
var oDE=_oz(z,70,e,s,gg)
_(hCE,oDE)
_(o0D,hCE)
var cEE=_mz(z,'w-picker',['areaCode',71,'bind:__l',1,'bind:confirm',2,'class',3,'data-event-opts',4,'data-ref',5,'defaultVal',6,'hideArea',7,'mode',8,'timeout',9,'vueId',10],[],e,s,gg)
_(o0D,cEE)
_(aPD,o0D)
var oFE=_n('view')
_rz(z,oFE,'class',82,e,s,gg)
var lGE=_n('view')
_rz(z,lGE,'class',83,e,s,gg)
var aHE=_oz(z,84,e,s,gg)
_(lGE,aHE)
var tIE=_n('text')
_rz(z,tIE,'class',85,e,s,gg)
var eJE=_oz(z,86,e,s,gg)
_(tIE,eJE)
_(lGE,tIE)
_(oFE,lGE)
var bKE=_mz(z,'input',['class',87,'name',1,'value',2],[],e,s,gg)
_(oFE,bKE)
_(aPD,oFE)
_(lOD,aPD)
var oLE=_n('view')
_rz(z,oLE,'class',90,e,s,gg)
var xME=_mz(z,'image',['class',91,'mode',1,'src',2],[],e,s,gg)
_(oLE,xME)
var oNE=_mz(z,'button',['class',94,'formType',1],[],e,s,gg)
_(oLE,oNE)
_(lOD,oLE)
_(cJD,lOD)
_(oHD,cJD)
...
var z=gz$gwx_5()
var cPE=_n('view')
_rz(z,cPE,'id',0,e,s,gg)
var hQE=_n('view')
_rz(z,hQE,'class',1,e,s,gg)
var oRE=_mz(z,'image',['mode',2,'src',1],[],e,s,gg)
_(hQE,oRE)
var cSE=_n('view')
...
var oZE=_mz(z,'button',['bindtap',8,'class',1,'data-event-opts',2],[],e,s,gg)
var x1E=_n('text')
...
setCssToHead([])();setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:970:6)",{path:"./app.wxss"})();

__wxAppCode__['app.wxss']=setCssToHead([[2,0]],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./app.wxss:970:6)",{path:"./app.wxss"});    
...
__wxAppCode__['pages/home/index.wxss']=setCssToHead(["@charset \x22UTF-8\x22;\n#homePage .",[1],"AppName { padding-left: ",[0,50],"; }\n#homePage .",[1],"avatar { position: fixed; top: ",[0,140],"; right: ",[0,50],"; width: ",[0,120],"; height: ",[0,120],"; overflow: hidden; box-shadow: 0 0  ",[0,10]," ",[0,8]," #69417C; }\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/home/index.wxss:30:1)",{path:"./pages/home/index.wxss"});    
